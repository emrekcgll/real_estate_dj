...
urlpatterns = [
    ...
    path("estates-on-rent/", views.estates_on_rent, name="estates_on_rent"), # kiralık evler
    path("estates-on-rented/", views.estates_on_rented, name="estates_on_rented"), # kiralanan evler
    path("estates-on-sale/", views.estates_on_sale, name="estates_on_sale"), # satılık evler
    path("estates-on-sold/", views.estates_on_sold, name="estates_on_sold"), # satılan evler
